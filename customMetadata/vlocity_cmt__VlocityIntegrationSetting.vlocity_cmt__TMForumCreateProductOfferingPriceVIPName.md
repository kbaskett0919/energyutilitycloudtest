...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>TMForumCreateProductOfferingPriceVIPName</label>
    <protected>false</protected>
    <values>
        <field>vlocity_cmt__APIName__c</field>
        <value xsi:type="xsd:string">TMForumCreateProductOfferingPrice</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">tmf_TMForumCreateProductOfferingPrice</value>
    </values>
    <values>
        <field>vlocity_cmt__Description__c</field>
        <value xsi:type="xsd:string">This is used for configuring vip name for create product offering price API</value>
    </values>
    <values>
